      ...
      <div className="flex justify-between items-center">
        ...
        {Icon && (
          <div className="relative group">
            <div 
              className="p-4 rounded-xl backdrop-blur-cosmic transition-all duration-300 group-hover:scale-110"
              style={{ 
            ...
            <div className="absolute -top-1 -right-1 w-3 h-3 bg-gradient-to-r from-blue-400 to-blue-500 rounded-full animate-pulse group-hover:animate-glow"></div>
            <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          </div>
        )}
      </div>
    </div>
